package com.atlxl.ct.producer.bean;

import com.atlxl.ct.common.bean.DataIn;
import com.atlxl.ct.common.bean.DataOut;
import com.atlxl.ct.common.bean.Producer;
import com.atlxl.ct.common.util.DateUtil;
import com.atlxl.ct.common.util.NumberUtil;
...
//            }
            ...
            while (flg){
                ...
                // 通话时间字符串
                String callTimeString = DateUtil.fromat(new Date(calltime), "yyyyMMddHHmmss");
